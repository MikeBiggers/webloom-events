...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-96 h-96 rounded-full opacity-20 blur-3xl" style={{ background: "#C17F87" }} />
      <div className="absolute bottom-10 left-0 w-80 h-80 rounded-full opacity-15 blur-3xl" style={{ background: "#C9A96E" }} />
      <div className="absolute top-1/2 left-1/4 w-64 h-64 rounded-full opacity-10 blur-2xl" style={{ background: "#8FAF8C" }} />

      <svg className="absolute top-8 left-8 opacity-20 hidden md:block" width="120" height="120" viewBox="0 0 120 120" fill="none" aria-hidden="true">
      ...
      <svg className="absolute bottom-16 right-10 opacity-15 hidden md:block" width="90" height="90" viewBox="0 0 120 120" fill="none" aria-hidden="true">
